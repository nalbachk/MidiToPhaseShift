...
@XmlRootElement
public class ConfigBassReal4 extends ConfigStrings implements Serializable {
	private static Logger LOG = LogManager.getLogger(ConfigBassReal4.class);

	private static final long serialVersionUID = 1L;

	public ConfigBassReal4() {
		// nothing
	}
	...
	protected void initMapMidiToPhaseShift() {
		...
		mapMidiToPhaseShift.put(48, new NotePhaseShift(lineNr, 5));
		mapMidiToPhaseShift.put(49, new NotePhaseShift(lineNr, 6));
		mapMidiToPhaseShift.put(50, new NotePhaseShift(lineNr, 7));
		mapMidiToPhaseShift.put(51, new NotePhaseShift(lineNr, 8));
		mapMidiToPhaseShift.put(52, new NotePhaseShift(lineNr, 9));

		mapMidiToPhaseShift.put(53, new NotePhaseShift(lineNr, 10));
		mapMidiToPhaseShift.put(54, new NotePhaseShift(lineNr, 11));
		mapMidiToPhaseShift.put(55, new NotePhaseShift(lineNr, 12));
		mapMidiToPhaseShift.put(56, new NotePhaseShift(lineNr, 13));
		mapMidiToPhaseShift.put(57, new NotePhaseShift(lineNr, 14));

		mapMidiToPhaseShift.put(58, new NotePhaseShift(lineNr, 15));
		mapMidiToPhaseShift.put(59, new NotePhaseShift(lineNr, 16));
		mapMidiToPhaseShift.put(60, new NotePhaseShift(lineNr, 17));
		mapMidiToPhaseShift.put(61, new NotePhaseShift(lineNr, 18));
		mapMidiToPhaseShift.put(62, new NotePhaseShift(lineNr, 19));

		mapMidiToPhaseShift.put(63, new NotePhaseShift(lineNr, 20));
		mapMidiToPhaseShift.put(64, new NotePhaseShift(lineNr, 21));
		mapMidiToPhaseShift.put(65, new NotePhaseShift(lineNr, 22));
	...
	public Integer getNoteMidi(NotePhaseShift notePhaseShift) {
		Integer noteMidi = 23 + notePhaseShift.getLineNr() * 5;
