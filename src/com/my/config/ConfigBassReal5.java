...
@XmlRootElement
public class ConfigBassReal5 extends ConfigStrings implements Serializable {
	private static Logger LOG = LogManager.getLogger(ConfigBassReal5.class);

	private static final long serialVersionUID = 1L;

	public ConfigBassReal5() {
		// nothing
	}
